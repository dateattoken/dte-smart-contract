...
contract DTEToken {
    ...
    string public name = "DTE Token" ;
    string public symbol = "DTE";
    uint8 public decimals = 8;
    uint256 totalSupply_ = 0;
    uint256 constant icoSupply = 160000000;
    uint256 constant foundersSupply = 60000000;
    uint256 constant yearlySupply = 75000000;
    
    mapping (address => uint) public freezedAccounts;
    
    uint constant founderFronzenUntil = 1569888000; //2019-10-01
    uint constant year1FronzenUntil = 1569888000; //2019-10-01
    uint constant year2FronzenUntil = 1601510400; //2021-10-01
     ...
     */
    function DTEToken(address _founderAddress, address _year1, address _year2) public {
